...
local messages = "org.signal.Signal"
local webapp = "org.chromium.Chromium --app="
local freetube = "io.freetubeapp.FreeTube"

-- web apps (update with your own preferred services)
-- launch webapps as "org.chromium.Chromium --app='https://youtube.com'"
